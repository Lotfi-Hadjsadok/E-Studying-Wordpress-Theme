...
class Speciality
{
   ...
   public function get_specialities(int $page = null, int $id = null, string $taxonomy = null)
   {
      $args = array(
   ...
   {
      return array_filter($specialities, function ($value, $key) use ($faculty) {
   ...
   public function get_specialities_algorithm(string $faculty = null)
   {
      ...
      if ($faculty != null) {
         $specialities = $this->filter_using_faculty($visited_specialities, $faculty);
      }
      return $specialities;
   }
}
